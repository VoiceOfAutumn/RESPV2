...
export default function TopBar({ onMenuToggle }: { onMenuToggle?: () => void }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-16 bg-black/60 backdrop-blur-md text-white flex justify-between items-center px-4 sm:px-6 shadow z-50 border-b border-gray-800">
          ...
          >
            ...
            {user.role === 'admin' && (
              <>
                ...
                <Link
                  href="/admin"
                  className="flex items-center gap-2 px-4 py-2 text-purple-400 hover:bg-white/10 transition-colors duration-150"
                >
