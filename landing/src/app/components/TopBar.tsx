...
export default function TopBar({ onMenuToggle }: { onMenuToggle?: () => void }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-16 bg-transparent backdrop-blur-md text-white flex justify-between items-center px-4 sm:px-6 z-50 border-b border-white/[0.06]">
